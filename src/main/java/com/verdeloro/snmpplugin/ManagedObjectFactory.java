...
import com.verdeloro.snmpplugin.objects.CustomManagedObject;
...
public class ManagedObjectFactory {
    ...
    private static MOScalar getCustomManagedObject(OID oid, MOAccess access, String objectName) {
        ...
        try {
            ...
            mo = (CustomManagedObject) Class.forName("com.verdeloro.snmpplugin.objects." + capitalize(objectName))
