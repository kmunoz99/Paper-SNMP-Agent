...
public class SNMPAgent extends BaseAgent {
    ...
    public void registerCustomMIB() {
        ...
        registerManagedObject(ManagedObjectFactory.createReadOnly(customMibOid + ".1.3.0", "RamUsage"));
        registerManagedObject(ManagedObjectFactory.createReadOnly(customMibOid + ".1.4.0", "PlayerCount"));
